...
public:
	...
	bool getALPNproto(std::string &proto);
		/// Returns true and sets proto to the protocol returned via ALPN
		/// false if no proto was set
...
inline bool SecureStreamSocketImpl::getALPNproto(std::string &proto)
{
	return _impl.getALPNproto(proto);
}
